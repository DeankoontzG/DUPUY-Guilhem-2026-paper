...
from NullModelsInference import *
from LouvainDecorele import *
from SiNEcustom import *
from ResidualDeterrenceEmbedding import *
...
EMBEDDINGS = ["ResDeterEmb", "deepwalk", 'SiNEcustom_spatial']

COMMUNITY_ALGOS = ['louvain', 'spatial_louvain_stdized']
...
COMMUNITY_MAPPING = {
    ...
    "spatial_louvain_stdized" : _appendSpatialLouvainCommunities_stdized,
}
